...
- Then, we **chose the theme “Wellness Tracker”** because it helps people live a balanced life.  
- Together we **designed the wireframe and prototype** using *Figma* and paper sketches.  
- We used **React + Tailwind CSS** to make a realistic app mockup.  
- Everyone helped with **UI design, colors, and testing the flow**.  

During our teamwork, we shared tasks:
- One member worked on navigation and structure.
...
3. Open the **Terminal** (shortcut `Ctrl + ``)
4. Type:
   ```bash
   npm install
   npm run dev
...
> The app works best in a mobile-sized browser window.
